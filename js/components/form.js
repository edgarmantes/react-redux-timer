	...
	return (
		<form className={props.name} >
			<div className="input-container">
				...
				<div className="password-cont"><img className="input-img input-password-img" src="../images/lock.png" /><input className={props.name + "-input loginInPut"} type="password" name={props.password} placeholder="Password" required /></div>
			</div>
